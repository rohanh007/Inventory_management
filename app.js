...
const dbURI = "mongodb+srv://chatgpt:chatgpt@cluster1.uwwe0lu.mongodb.net/products";
...
app.post('/edit/:id',(req,res)=>{
  console.log("POST req made on"+req.url);
  User.updateOne({ _id: req.params.id }, { $set: req.body }) //then updating that user whose id is get from url 
    .then(result => {
      res.redirect('/users');//is success save this will redirect to home page
